...
7. Для проверки в sonarqube до помещения изменений в хранилище в 1С необходимо выйти из конфигурации и выполнить команду `git_commit_ib_xml`:
   ...
   - Необходимо зайти в сервис внешнего git хранилища, например, gitlab и создать запрос на слияние относительно главной ветки, и созданной ветки.
     - Для автоматического создания запроса на слияние в Gitlab можно использовать [docker контейнер gitlab-auto-mr](https://github.com/agibalovsa/-1C_DevOps/tree/master/docker/gitlab-ce/build/gitlab-auto-mr)
     - Для автоматического создания MR для веток с именем CodeReview* можно использовать [файл .gitlab-ci](https://github.com/agibalovsa/-1C_DevOps/blob/master/docker/gitlab-ce/gitlab-ci/.gitlab-ci.yml)
